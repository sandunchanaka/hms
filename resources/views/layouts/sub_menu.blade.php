...
@role('Admin|Pharmacist|Lab Technician')
    @module('Medicines', $modules)
        ...
        @module('Operation Categories', $modules)
            <li
                class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*', 'pet-categories*', 'payment-gateways*','add-custom-fields*') ? '' : 'd-none' }}">
        ...
        @endmodule
        {{-- @module('Pet Categories', $modules) --}}
            <li
                class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*', 'pet-categories*','payment-gateways*','add-custom-fields*') ? '' : 'd-none' }}">
                <a class="nav-link p-0 {{ Request::is('pet-categories*') ? 'active' : '' }}"
                    href="{{ route('pet.category.index') }}">
                    {{ __('messages.pet_category.pet_categories') }}
                </a>
            </li>
        {{-- @endmodule --}}
        @role('Admin')
            {{-- <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ Request::is('settings*', 'currency-settings*', 'hospital-schedules', 'operation-categories*', 'operations*', 'pet-categories*', 'payment-gateways*','add-custom-fields*') ? '' : 'd-none' }}">
