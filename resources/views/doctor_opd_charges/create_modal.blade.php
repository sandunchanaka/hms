            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <span class="required"></span>
                        {{ Form::text('standard_charge', null, ['class' => 'form-control price-input', 'autocomplete' => 'off', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','placeholder'=>__('messages.doctor_opd_charge.standard_charge')]) }}
                    </div>
                </div>
            </div>
