        ...
        <div class="dropdown-menu py-0" aria-labelledby="medicineCategoryFilterBtn">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('status', collect($filterHeads[0])->sortBy('key')->toArray(),null, ['id' => 'medicineCategoryHead', 'data-control' =>'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                </div>
