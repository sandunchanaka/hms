<div class="row">
    ...
    <div class="col-sm-6 mb-5">
        ...
        {{ Form::text('amount', null, ['class' => 'form-control price-input price', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','placeholder'=>__('messages.payment.amount')]) }}
    </div>
    <div class="col-sm-6 mb-5">
