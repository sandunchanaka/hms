...
Route::middleware('auth', 'verified', 'xss', 'checkUserStatus')->group(function () {
    ...
    // Pet Categories
    Route::get('pet-categories', [PetCategoryController::class, 'index'])
        ->name('pet.category.index');
    Route::post('pet-categories', [PetCategoryController::class, 'store'])->name('pet.category.store');
    Route::get('pet-categories/{petCategory}', [PetCategoryController::class, 'show'])->name('pet.category.show');
    Route::delete('pet-categories/{petCategory}', [PetCategoryController::class, 'destroy'])->name('pet.category.destroy');
    Route::patch('pet-categories/{petCategory}', [PetCategoryController::class, 'update'])->name('pet.category.update');
    Route::get('pet-categories/{petCategory}/edit', [PetCategoryController::class, 'edit'])->name('pet.category.edit');
    Route::get('pet-name-get', [PetCategoryController::class, 'getPetName'])->name('pet.name.get');
});
